...
GCOV_REPORT := "bacon.c.gcov"

all:; @$(MAKE) _all -j
_all: setup $(BIND)/$(TEST) $(AUX_PGMS) $(ALL_OBJF)
...
gcov:
	@gcov bacon.o -o build -s src > /dev/null 2>&1
	@echo Generated unit test coverage report for bacon.c. See $(GCOV_REPORT)
